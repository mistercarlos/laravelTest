    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <!-- /.card-header -->
        <form method="post" action='{{route("$active_dir.store")}}' enctype="multipart/form-data" >
          @csrf
          <div class="card-body">
            <div class="row">
              <div class="col-sm-12">
              ...
              <div class="col-sm-6">
                ...
                <div class="form-group clearfix">
                  <div class="icheck-primary d-inline">
                    <input type="radio" value="1" id="radioPrimary1" name="active" checked>
                    <label for="radioPrimary1">
                      Yes
                    </label>
                  </div>
                  <div class="icheck-primary d-inline">
                    <input type="radio" value="0" id="radioPrimary3" name="active" >
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <div class="custom-file">
                <input type="file" accept="application/pdf" name="document" class="custom-file-input" id="customFile2">
