            ...
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="proposal" id="" cols="30" rows="10"></textarea>
                </div>
              </div>
            </div>
              ...
              <div class="col-sm-6">
                ...
                <div class="form-group clearfix">
                  <div class="icheck-primary d-inline">
                    <input type="radio" value="1" id="radioPrimary1" name="favorite" checked>
                    <label for="radioPrimary1">
                      Yes
                    </label>
                  </div>
                  <div class="icheck-primary d-inline">
                    <input type="radio" value="0" id="radioPrimary3" name="favorite" >
