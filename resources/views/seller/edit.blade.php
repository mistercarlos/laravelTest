              ...
              <div class="col-sm-6">
                ...
                <div class="form-group clearfix">
                  <div class="icheck-primary d-inline">
                    <input type="radio" value="1" id="radioPrimary1" name="active" {{ $data->active == 1 ? 'checked' : '' }} >
                    <label for="radioPrimary1">
                      Yes
                    </label>
                  </div>
                  <div class="icheck-primary d-inline">
                    <input type="radio" value="0" id="radioPrimary3" name="active" {{ $data->active == 0 ? 'checked' : '' }} >
